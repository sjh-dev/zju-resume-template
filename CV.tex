...
\pagenumbering{gobble}
 ...
 \begin{tikzpicture}[remember picture, overlay]
   \node[anchor = north east] at ($(current page.north east)+(-2cm,-1.2cm)$)
     {\includegraphics[height=3cm]{pic.png}};
 \end{tikzpicture}
...
\noindent
\begin{tabular*}{\textwidth}{@{}p{8.6cm}@{\hspace{0.6em}}l@{\hspace{1.2em}}l@{\extracolsep{\fill}}r@{}}
\textbf{硕士：中国科学技术大学} & 前25\% & 软件工程 & 2024.09 -- 2027.06
\end{tabular*}
\begin{itemize}[nosep]
...
\noindent
\begin{tabular*}{\textwidth}{@{}p{8.6cm}@{\hspace{0.6em}}l@{\hspace{1.2em}}l@{\extracolsep{\fill}}r@{}}
\textbf{本科：哈尔滨工业大学（深圳）} & 前30\% & 计算机科学与技术 & 2020.09 -- 2024.06
\end{tabular*}
\begin{itemize}[nosep]
...
\textbf{快手} \hfill 2025.09 -- 2026.04 \titlebreak
后端开发实习生\quad 快手 - 主栈开发部
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
  \item \textbf{AI 智能素材标注与视频包装WorkFlow建设}
  \begin{itemize}[nosep]
    \item \textbf{AI 特征库建设}：负责素材智能标注链路设计与研发，对接LLM获取视频特征；基于 \textbf{Elasticsearch} 搭建正排索引支撑毫秒级检索，并同步落盘至 DB，打通 AI 特征上下游流转。
    \item \textbf{自动化视频包装}：扩展并开发现有 AI WorkFlow系统，搭建以 AI 为核心的视频包装任务流；支持用户输入视频与风格配置后，自动检索 ES 素材特征并渲染生成 AI 视频效果，提升内容创作效率。
  \end{itemize}
  ...
  \begin{itemize}[nosep]
    ...
    \item \textbf{数据库性能调优}：使用新用户空数据过滤机制，拦截大量无效穿透查询，降低 DB 集群压力，保障数据中心高可用，并通过定时任务流转每日数据，减少DB成本。
  \end{itemize}
  \item \textbf{商业化 DSP 广告归因系统对接以及广告弹窗开发}
  \begin{itemize}[nosep]
    \item \textbf{多维归因链路升级}：对接多家外部广告服务商（如巨量引擎），实现投放报表自动化拉取与转化数据回传；扩充下发维度与字段，提升多维归因覆盖率与准确性。
    \item \textbf{广告弹窗开发}：参与商业化广告弹窗能力建设，完成弹窗策略下发、展示频控与曝光/点击回调链路对接，支撑广告位灵活配置与投放效果回收。
...
\textbf{百度智能云平台} \hfill 2025.06 -- 2025.08 \titlebreak
后端实习生实习生\quad 百度智能云 - 通用数据部\\[0.2em]
参与BMR大数据平台研发：BMR 基于 Spark / Hadoop 生态提供托管集群能力；\textbf{bmr-monitor} 负责状态监控与异常告警，\textbf{bmr-agent} 负责组件指标采集。
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
...
\begin{itemize}[nosep]
  ...
  \item \textbf{AIGC方面：}熟悉RAG 、Agent、Prompt、AI WorkFlow等AIGC相关技术，并有过搭建成熟AI工作流的工程经历。
\end{itemize}
%% ==================== 社会实践与校园经历 ====================
\section{\makebox[\widthof{\faUsers}][c]{\color{CVBlue}\faUsers}\ 社会实践与校园经历}
\begin{itemize}[nosep]
  \item \textbf{社会实践}：积极参与社会志愿者活动，获得50个小时志愿时长。
  \item \textbf{校园经历}：研究生阶段：2024.09 -- 2025.09 担任24级软件工程网络与信息二班班级团支部的组织委员，2025年9月 -- 至今担任班级团支部副团支书；本科阶段：2020.09 -- 2024.06 担任2020级计算机科学与技术10班学习委员。
\end{itemize}
