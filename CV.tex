...
\textbf{中国科学技术大学} \hfill 2024.09 -- 2027.06\\[0.3em]
软件工程\quad 硕士\quad 软件学院\quad 全日制
\begin{itemize}[nosep]
  \item 荣誉奖项：校级优秀共青团员，校级优秀学生干部
\end{itemize}

\vspace{0.4em}
\textbf{哈尔滨工业大学（深圳）} \hfill 2020.09 -- 2024.06\\[0.3em]
计算机科学与技术\quad 本科\quad 计算机学院\quad 全日制
\begin{itemize}[nosep]
  \item 荣誉奖项：校级三等奖学金；第三届「大湾区杯」粤港澳金融数学建模竞赛本科组二等奖
\end{itemize}
...
项目介绍：Baidu-MapReduce（BMR）为集成大数据组件的 Spark 集群，提供 Hadoop 生态能力；\textbf{bmr-monitor} 负责监控集群状态并报警，\textbf{bmr-agent} 负责采集组件信息。
\begin{itemize}[nosep, topsep=\intraProjectListTopSep]
  \item 实现集群巡检任务的定期数据采集，支持周期性巡检并出具集群巡检指标报告。
  \item 基于 BCM 平台巡检报告指标编写 Prompt，搭建 \textbf{RAG} 应用，完成智能巡检需求。
  \item 协助组件性能测试，使用 Spark 提交 TPC-DS 任务，评估集群数据处理性能。
\end{itemize}

%% ==================== 专业技能 ====================
\section{\makebox[\widthof{\faCogs}][c]{\color{CVBlue}\faCogs}\ 专业技能}
\begin{itemize}[nosep]
  \item \textbf{编程语言：} 熟悉 Java 基础与集合框架。
  \item \textbf{数据库：} 熟悉 MySQL 索引、事务、锁机制；熟悉 Redis 数据结构、持久化与过期淘汰策略，了解缓存穿透/击穿/雪崩等场景。
  \item \textbf{开发框架：} 熟练使用 Spring Boot、SpringMVC、MyBatis-Plus，熟悉 Spring IOC、AOP 原理。
  \item \textbf{计算机基础：} 熟悉 TCP/IP 分层及 HTTP/HTTPS、TCP、UDP；熟悉进程通信与死锁等操作系统知识。
\end{itemize}

%% ==================== 荣誉奖项 ====================
\section{\makebox[\widthof{\faList}][c]{\color{CVBlue}\faList}\ 荣誉奖项}
\begin{itemize}[nosep]
  \item 校级优秀共青团员、校级优秀学生干部 \hfill 中国科学技术大学
  \item 哈尔滨工业大学（深圳）学业三等奖学金 \hfill 2020
  \item 第三届「大湾区杯」粤港澳金融数学建模竞赛本科组二等奖 \hfill 2022
\end{itemize}

%% ==================== 其他 ====================
\section{\makebox[\widthof{\faInfo}][c]{\color{CVBlue}\faInfo}\ 其他}
\begin{itemize}[parsep=0.5ex]
  \item \textbf{现居城市：} 广东深圳
  \item \textbf{求职意向：} Java / 后端开发
\end{itemize}
